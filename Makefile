...
SRC_FILES       = main.c word_count.c tokenization.c token_definition.c is_something.c lst_create.c set_heredoc.c set_redir_file.c handle_cmd_type.c lst_cmd_utils.c find_env_var.c error_check.c free_utils.c last_split.c utils.c new_token_utils.c remove_quotes.c get_env_var.c
BUILTINS_FILES  =
